	...
	SubShader
	{
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float3 temp_output_13_0_g281 = Emission355.rgb;
				...
				float4 staticSwitch364 = float4( ( Emission355.rgb + ( Ambient_Occlusion133 * ( Albedo138.rgb * color4_g279 ) ) ) , 0.0 );
				#else
			...
			//---------------------------------------------------------------------------------------------------------------------------
				...
				half3 emission = ( staticSwitch32_g281 == 1.0 ? float4( staticSwitch30_g281 , 0.0 ) : staticSwitch364 ).rgb;
...
Node;AmplifyShaderEditor.CommentaryNode;357;1168,816;Inherit;False;1144.259;471.978;;6;362;361;360;359;358;364;Non-Linear Probe;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;14;320,1280;Inherit;False;Property;_BakedMutiplier;Emission Baked Mutiplier;15;0;Create;False;0;0;0;True;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;306;1344,304;Inherit;False;BakeryMonoSH;22;;281;29c9468cd28079b448a58bef1fb32cb5;0;6;8;FLOAT3;0,0,0;False;9;FLOAT3;0,0,0;False;10;FLOAT;0;False;11;FLOAT;0;False;12;FLOAT;0;False;13;FLOAT3;0,0,0;False;2;FLOAT3;0;FLOAT;31
Node;AmplifyShaderEditor.StaticSwitch;364;1664,1104;Inherit;False;Property;_NonLinearLightProbeSH;Non-Linear Light Probe SH;28;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;351;656,1008;Inherit;False;Property;_UseFalloffInBake;Use Falloff In Bake;13;0;Create;True;0;0;0;False;0;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.Compare;363;2128,672;Inherit;False;0;4;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT3;0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=3F9A2D3A1C5995036ABEFBF3ED496F94246E78B6