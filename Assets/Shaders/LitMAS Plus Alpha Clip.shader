	...
	SubShader
	{
		...
		Pass
		{
			...
			//---------------------------------------------------------------------------------------------------------------------------
				...
				half3 emission = ( staticSwitch32_g263 == 1.0 ? float4( staticSwitch30_g263 , 0.0 ) : staticSwitch364 ).rgb;
...
ASEEND*/
//CHKSM=36D3A99021CFA4B9837C08AB90D1DF78CB1912F1